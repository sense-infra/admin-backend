...
func main() {
	...
	apiKeyUpdateRoutes.HandleFunc("/{id:[0-9]+}/deactivate", authHandler.DeactivateAPIKey).Methods("PUT")
	...
	apiKeyDeleteRoutes.HandleFunc("/{id:[0-9]+}", authHandler.DeleteAPIKey).Methods("DELETE")                    // Backward compatibility - calls deactivate
	apiKeyDeleteRoutes.HandleFunc("/{id:[0-9]+}/deactivate", authHandler.DeactivateAPIKey).Methods("DELETE")     // Explicit deactivate
	apiKeyDeleteRoutes.HandleFunc("/{id:[0-9]+}/permanent", authHandler.PermanentlyDeleteAPIKey).Methods("DELETE") // Permanent delete
